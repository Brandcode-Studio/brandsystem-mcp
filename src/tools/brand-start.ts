    ...
    data: {
      ...
      conversation_guide: {
        instruction: [
          ...
          "5. After confirmation, mention: 'Your brand runtime and interaction policy are compiled. Any MCP-connected tool now has your brand context.'",
          "6. Suggest next steps: Session 2 ('Want to go deeper into your visual identity?') or Brandcode Studio ('Want to save this and share with your team? Run brand_brandcode_connect.')",
