    ...
    data: {
      ...
      conversation_guide: {
        instruction: [
          ...
          "  A → Run brand_extract_web (with the website_url if provided)",
          "  B → Ask for their Figma file key, then run brand_extract_figma",
          "  C → Ask them to share/upload their brand guidelines document, then extract values manually",
          "  D → Ask them to share/upload an on-brand asset, then analyze it and extract values",
